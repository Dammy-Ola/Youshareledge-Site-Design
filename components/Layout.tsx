...
Layout.defaultProps = {
  title: 'Youshareledge - Learn and share your knowledge with the world',
  description: 'Learn and share your knowledge with the world',
  keywords: 'Youshareledge, Learn, knowledge',
}
